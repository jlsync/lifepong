...
class StateMachine extends EventEmitter
  ...
  constructor: () ->
    ...
    @states = {}
    @events = {}
    @addState name, attrs for name, attrs of @constructor.states
    @addEvent name, attrs for name, attrs of @constructor.events
    @states[@initial_state_name] or @addState @constructor.initial_state_name
    ...
    @move_state @constructor.initial_state_name, initialise
